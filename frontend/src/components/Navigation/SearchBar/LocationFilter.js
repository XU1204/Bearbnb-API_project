...
// export default function LocationFilter({ apiKey, hasSubmitted, errors, setErrors, minLat, setMinLat, maxLat, setMaxLat, minLng, setMinLng, maxLng, setMaxLng, setCenter, center }) {
